package com.atguigu.warehousr.service

import com.atguigu.warehousr.bean.{IdlMember, IdlMember_Result, MemberZipper, MemberZipperResult}
import com.atguigu.warehousr.dao.BdlMemberDao
import org.apache.spark.sql.{SaveMode, SparkSession}

object IdlMemberService {

  def importMemberUseApi(sparkSession: SparkSession) = { //隐式转换
